...
export const Country = () => {
  ...
  useEffect(() => {
    ...
    fetch(url, requestOptions)
      ...
      .catch((error) => console.error(error));console.log(country);
  }, [url]); // Include 'url' as a dependency to trigger useEffect when it changes
...
{country.length > 0 ? (
        ...
        <div key={index}>
          <div className='h-80 w-64 m-4 shadow-xl'>
            <div className='w-full h-2/4 my-2'>
              <img src={countryData.flags.svg} className='h-full' alt='Country Flag'/>
            </div>
            <div className='m-6'>
      ...
      <div className='text-6xl w-5/6 m-auto text-center mt-28 '>Loading...</div>
    )}
